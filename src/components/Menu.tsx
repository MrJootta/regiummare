      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative" ref={popoverRef}>
            ...
            {popoverOpen && (
              <PopoverPanel
                className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-sm border border-gray-200"
          ...
          <a href="/sobre-nos" className="text-sm leading-6 font-semibold text-gray-900">
            Sobre Nós
          </a>
          <a href="/contactos" className="text-sm leading-6 font-semibold text-gray-900">
            Contactos
          </a>
        </PopoverGroup>
      </nav>
